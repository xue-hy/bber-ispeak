                        ...
                        o = {
                            ...
                            methods: {
                                formatBody: function(e) {
                                    ...
                                    return function(e) {
                                        e = (e = e.replace(/<img [^>]*src=['"]([^'"]+)[^>]*>/gm, (function(e, t, n, r) { return t }))).replace(/!\[(.*?)\]\((.*?)\)/gm, (function(e, t, n) { return n }));
                                        var t = /[a-zA-z]+:\/\/[^\s]*/g,
                                            n = /((?<=\?id=)(.*?)(?=&uct))|((?<=\&songmid=)(.*?)(?=&type))|((?<=\&id=)(.*?)(?=&ADTAG=))|((?<=playlist\?id=)(.*?)(?=&userid=))|(?<=playlist\/).*$|((?<=h5_playsong\&mid=)(.*?)(?=\&no_redirect))|((?<=songDetail\/)(.*?)(?=\?songtype=))/g;
                                        if (/(&songmid=)|(song\?id=)|(songDetail)/g.test(e)) var r = "song";
                                        else r = "playlist";
                                        if (/y.qq.com/g.test(e)) {
                                            var i = "tencent",
                                                o = e.match(n);
                                            e = e.replace(t, (function(e) { return '<meting-js server="' + i + '" type="' + r + '" id="' + o + '"> </meting-js>' }))
                                        } else /music.163.com/g.test(e) && (i = "netease", o = e.match(n), e = e.replace(t, (function(e) { return '<meting-js server="' + i + '" type="' + r + '" id="' + o + '"> </meting-js>' })));
                                        return e = (e = e.replace(/\bhttps?:[^:<>"]*\/([^:<>"]*)(\.(jpeg)|(png)|(jpg)|(webp))/g, (function(e) { return '<a href="'.concat(e, '" target="_blank" data-fancybox="group" class="fancybox">\n            <img src="').concat(e, '" ></a>') }))).replace(/\bhttps?:\/\/(?!\S+(?:jpe?g|png|bmp|gif|webp|gif|mp4))\S+/g, (function(e) { return "<a href='".concat(e, "' rel='noopener' target='_blank'>↘链接↙</a>") })), window.qqWechatEmotionParser && (e = qqWechatEmotionParser(e)), e
                                    }(e)
                                }
                            }
                        };
