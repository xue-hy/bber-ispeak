                                ...
                                formatBody: function(e) {
                                    ...
                                    return function(e) {
                                        ...
                                        if (/y.qq.com/g.test(e)) {
                                            var o = "tencent",
                                                i = e.match(n);
                                            e = e.replace(t, (function(e) { return '<meting-js server="' + o + '" type="' + r + '" id="' + i + '"> </meting-js>' }))
                                        } else /music.163.com/g.test(e) && (o = "netease", i = e.match(n), e = e.replace(t, (function(e) { return '<meting-js server="' + o + '" type="' + r + '" id="' + i + '"> </meting-js>' })));
